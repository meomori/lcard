...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post professionals_url, params: { professional: { email: @professional.email, github: @professional.github, linkedin: @professional.linkedin, name: @professional.name, phone: @professional.phone, website: @professional.website } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { email: @professional.email, github: @professional.github, linkedin: @professional.linkedin, name: @professional.name, phone: @professional.phone, website: @professional.website } }
